...
base_page = "https://abeautifulmess.com/category/food/page/{page}/"
max_page = 137
...
with tqdm(range(max_page), desc="Scraping Recipes") as progress_bar:
    for page in progress_bar:
        ...
        if page_request.status_code == 200:
            ...
            recipes = [
                a["href"]
                for a in soup.find_all("a", class_="entry-image-link", recursive=True)
            ]
...
with open("a_beautiful_mess.txt", "w") as f:
    f.write("\n".join(recipe_links))
