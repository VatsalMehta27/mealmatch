...
base_page = "https://www.gimmesomeoven.com/all-recipes/?fwp_paged={page}&fwp_per_page=100&fwp_sort=date_desc"
max_page = 20
    ...
    for page in progress_bar:
        ...
        if page_request.status_code == 200:
            ...
            recipes = [
                ...
                for div in soup.find_all("div", class_="teaser-post-sm", recursive=True)
            ]
...
with open("gimme_some_oven_links.txt", "w") as f:
    f.write("\n".join(recipe_links))
