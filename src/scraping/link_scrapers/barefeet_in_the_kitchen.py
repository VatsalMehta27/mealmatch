...
base_page = "https://barefeetinthekitchen.com/recipes/?_paged={page}/"
max_page = 54
        ...
        if page_request.status_code == 200:
            ...
            recipes = [
                ...
                for a in soup.find_all(
                    "a", class_="post-summary__image-link", recursive=True
                )
            ]
...
with open("barefeet_in_the_kitchen.txt", "w") as f:
    f.write("\n".join(recipe_links))
