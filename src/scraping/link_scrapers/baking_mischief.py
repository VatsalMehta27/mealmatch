...
base_page = "https://bakingmischief.com/category/recipes/page/{page}/"
max_page = 79
...
with tqdm(range(max_page), desc="Scraping Recipes") as progress_bar:
    for page in progress_bar:
        ...
        if page_request.status_code == 200:
            ...
            recipes = [
                a["href"]
                for a in soup.find_all("a", class_="entry-title-link", recursive=True)
            ]
...
with open("baking_mischief.txt", "w") as f:
    f.write("\n".join(recipe_links))
