...
base_page = "https://glutenfreeonashoestring.com/gluten-free-recipes/page/{page}/"
max_page = 40
    ...
    for page in progress_bar:
        ...
        if page_request.status_code == 200:
            ...
            recipes = [
                ...
                for div in soup.find_all("div", class_="each-post", recursive=True)
            ]
...
with open("gf_on_a_shoe_string_links.txt", "w") as f:
    f.write("\n".join(recipe_links))
